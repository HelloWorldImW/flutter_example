 ...
 * @Date: 2021-09-16 08:56:58
 * @Description: 
 * @FilePath: /flutter_example/lib/pages/colors.dart
...
class ZHColors extends StatelessWidget {
  /// Creates the main Application class.
  const ZHColors({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ImageColors(
        title: 'Image Colors',
        image: AssetImage('images/juice2.png'),
      ),
    );
  }
}
